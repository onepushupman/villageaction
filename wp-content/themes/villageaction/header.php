...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header">
		<div class="site-branding ">
			...
			$villageaction_description = get_bloginfo( 'description', 'display' );
			if ( $villageaction_description || is_customize_preview() ) :
				?>
				<p class="site-description"><?php echo $villageaction_description; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></p>
			<?php endif; ?>
		</div><!-- .site-branding -->
